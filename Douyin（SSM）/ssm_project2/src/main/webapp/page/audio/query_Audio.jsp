        ...
        <div class="col-sm-12">
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <form method="post"
                          style="float: right"
                          action="${pageContext.request.contextPath}/AudioController/getAudioByTitleAndBusinessID">
                        <input name="audio_title" type="text" placeholder="输入音频标题"/>
                        <input  type="submit"  value="搜索"/>
                    </form>
                    <div style="float: right;margin-left: 10px;margin-right: 10px;margin-top: 5px">
                        <a href="${pageContext.request.contextPath}/AudioController/getAudioInfoById"
                           style="float: right">查看全部</a>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <button type="button"
                                                ...
                                                data-toggle="modal"
                                                data-target="#myModal"
                                                onclick="changeAudiosrc('${info.audio_src}')"
                                        >查看</button>

                                    </td>
                                    <td>
                                        <form action="${pageContext.request.contextPath}/AudioController/deleteAudio">
                                            <input name="audio_id" type="hidden" value="${info.audio_id}"/>
                                            <input type="submit"  value="删除" style="margin-top: 13px"/>
                                        </form>
                                    </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <%--src:这个数据是动态的，被脚本设置的--%>
                <audio id="audiosrc" controls="" src=""  width="500" height="300"></audio>
