            ...
            <div class="ibox ">
                <div class="ibox-title">
                    ...
                    <div style="float: right;margin-left: 10px;margin-right: 10px;margin-top: 5px">
                        <a href="${pageContext.request.contextPath}/AudioController/getForbiddenAudioInfoById"
                           style="float: right">已禁用</a>
                    </div>
                </div>
                        ...
                        <table class="footable table table-stripped table-hover" data-page-size="8" data-filter=#filter>
                            ...
                            <c:forEach items="${list}" var="info">
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <form id="restore" action="${pageContext.request.contextPath}/AudioController/restoreAudio">
                                            <input name="audio_id" type="hidden" value="${info.audio_id}"/>
