...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-sm-8">
        <div class="title-action">
            <a href="add_date_model.html" class="btn btn-primary">编辑</a>
        </div>
    </div>
</div>
                ...
                <div class="ibox-content">
                    <form method="get" class="form-horizontal" action="${pageContext.request.contextPath}/SystemUserController/updateSystemUser">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label><input type="radio" checked value="男" id="user_sex_male" name="user_sex">男</label>
                                </div>
                                <div class="radio">
                                    <label><input type="radio" value="女" id="user_sex_female" name="user_sex">女</label>
                                </div>
                            </div>
                        </div>
