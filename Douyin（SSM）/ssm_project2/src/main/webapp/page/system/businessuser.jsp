...
<%--                                <th></th>--%>
                            ...
                            <c:forEach items="${businessList}" var="businessUser">
                                <tr class="gradeX">
                                    ...
                                    <td><button class="btn btn-primary" type="submit" id="${businessUser.business_id}" onclick="click1(this)">查看该用户上传视频</button></td>
                                    <td><button class="btn btn-primary" type="submit" id="${businessUser.business_id*(-1)}" onclick="click2(this)">查看该用户上传音频</button></td>
                                </tr>
                            </c:forEach>
...
<script type="text/javascript">
    $(function click1(busiUserid) {
        var business_id = busiUserid.id;

        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/BusinessVideoController/getBusinessVideoInfoById",
...
<script type="text/javascript">
    $(function click2(busiUseridMinus) {
        var business_id = busiUseridMinus.id * (-1);

        $.ajax({
            type: "POST",
            url: "${pageContext.request.contextPath}/BusinessAudioController/getBusinessAudioInfoById",
            data: "business_id="+business_id,
            success: function(data){
                // alert("操作成功");
            }
