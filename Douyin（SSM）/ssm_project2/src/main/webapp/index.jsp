...
<div class="middle-box text-center loginscreen  animated fadeInDown">
    <div>
        ...
        <form method="post" class="m-t" role="form" action="${pageContext.request.contextPath}/LoginController/login">
            ...
            <p class="text-muted text-center">
                <a href="${pageContext.request.contextPath}/businessLogin.jsp"><small>商户登录</small></a>|
